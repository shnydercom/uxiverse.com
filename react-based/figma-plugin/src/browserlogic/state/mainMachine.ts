        ...
        onmessage = event => {
          ...
          switch (plMsg.type) {
            ...
            case HostEventTypes.fetchSuccessful:
              ...
              break
            case HostEventTypes.compSearchDone:
              send({
