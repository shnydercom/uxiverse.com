...
import { HostAppElement, HostEventTypes, PluginEventTypes, PluginRenameBridgeEvent, PluginSelectionChangedBridgeEvent } from './../../communicationInterfaces'
  ...
  createMachine<MainMachineXSCtx>({
    ...
    actions: {
      ...
      assignUnlinkedData: (context, event: PluginUnlinkedDataUpdateEvent) => {
        if (context.host.selectionFocusedElement && context.plugin.renameValue) {
          // send to figma bridge
